...
See [/architecture/state-management](/en/architecture/state-management)
...
- [/architecture/state-management](/en/architecture/state-management)
- [/api/lib/editable-guard](/en/api/lib/editable-guard)
- [/api/lib/entity-ops](/en/api/lib/entity-ops)
- [/api/store/settings-store](/en/api/store/settings-store) — `historyLimit` source.
- [/api/store/ui-store](/en/api/store/ui-store) — non-undoable UX state.
