...
See [Types / inspectorSchema](/en/api/types/inspector-schema).
...
- [/api/lib/enum-labels](/en/api/lib/enum-labels) — paired display
  strings for every option array.
- [/api/io/proto-entity-bridge](/en/api/io/proto-entity-bridge) — wire ↔
  string enum conversion (the schemas mirror the entity union types).
- [/api/components/inspector-forms](/en/api/components/inspector-forms) —
  primary consumer.
