...
- [Geometry: coords](/en/api/core/geometry-coords) — `toLngLat` / `toGeoPoint` underneath
- [Geometry: interpolate](/en/api/core/geometry-interpolate) — `BezierAnchor` and `cubicBezier`
- [Geometry: connectLanes](/en/api/core/geometry-connect-lanes) — primary consumer of `anchorToRuntime`
- [Apollo compile: factory](/en/api/core/geometry-apollo-compile) — primary consumer of `anchorToData`
