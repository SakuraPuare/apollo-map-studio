...
- [License storage](/en/api/electron/license-storage) — uses `aesEncrypt` / `hmacHex` / `getFileKey`
- [License time-guard](/en/api/electron/license-time-guard) — same primitives
