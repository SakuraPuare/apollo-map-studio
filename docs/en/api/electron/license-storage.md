...
- [License crypto](/en/api/electron/license-crypto) — `aesEncrypt`, `hmacHex`, `getFileKey`, `getMacKey`, `sha256Hex`, `safeEqual`
- [License manager](/en/api/electron/license-manager) — primary consumer
- [License machine-id](/en/api/electron/license-machine-id)
